...
export const PERMISSION_MATRIX: Record<UserRole, Partial<Record<ResourceKey, ResourceScope>>> = {
  SUPER_ADMIN: {
    ...
    communication_log: { scope: 'global',   allowed: ['view','export'], maxSensitivity: 4 },
  ...
  SCHOOL_HEAD: {
    ...
    communication_log: { scope: 'school',   allowed: ['view','export'], maxSensitivity: 3 },
  ...
  ADMIN: {
    student:           { scope: 'school',   allowed: ['view','create','update','export'], maxSensitivity: 3 },
